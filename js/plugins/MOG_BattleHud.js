...
Scene_Battle.prototype.set_actor_command_pos = function() {
	...
	if (!this._actorCommandWindow.visible) {this._actorCommandWindow_org = [this.nx -20,this.ny]};
...
Battle_Hud.prototype.need_refresh_parameter = function(parameter) {
  switch (parameter) {
  	...
  	case 1:
         ...
         break;			
  	case 2:
         if (this._tp_old != this._battler.barrierPoints) {return true};
         break;					
  };
  return false;
};
...
Battle_Hud.prototype.create_face = function() {
	...
	if (!this._battler) {return};	
	this._face = new Sprite(ImageManager.loadBHud("Face_" + this._battler._actorId + "_" + this._battler._classId));
...
Battle_Hud.prototype.update_face_animation = function() {
	if (this._battler._bhud_face_data[3] > 0) {this._battler._bhud_face_data[3] -= 1;
	    if (this._battler._bhud_face_data[3] === 0) {
			...
			else if (this._battler.hp <= 30 * this._battler.mhp / 20) {this._battler._bhud_face_data[2] = 3}
...
Battle_Hud.prototype.update_tp = function() {
	if (this._tp_meter_blue) {
		if(this._tp_flow[0]) {
		   this.refresh_meter_flow(this._tp_meter_blue,this._battler.tp,20,0,this._tp_flow[1]);
	       ...
	       this.refresh_meter_flow(this._tp_meter_red,this._tp_old_ani[0],10,1,this._tp_flow[1]);
		   };
		   this._tp_flow[1] += 1.5;
		   if (this._tp_flow[1] > this._tp_flow[3]) {this._tp_flow[1] = 0};		   
			...
			if (this.need_refresh_parameter(2)) {
				this.refresh_meter(this._tp_meter_blue,this._battler.tp,10,0);
				this._tp_old = [this._battler.tp,10];
			};
			var dif_meter = this.update_dif(this._tp_old_ani[0],this._battler.tp,160)
			if (this._tp_old_ani[0] != dif_meter) {this._tp_old_ani[0] = dif_meter;
			this.refresh_meter(this._tp_meter_red,this._tp_old_ani[0],10,1);};
	};
    };
	if (this._tp_number) {
